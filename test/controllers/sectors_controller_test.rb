...
class SectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sector" do
    assert_difference('Sector.count') do
      post sectors_url, params: { sector: { name: @sector.name, postal_code: @sector.postal_code } }
    end
  ...
  test "should update sector" do
    patch sector_url(@sector), params: { sector: { name: @sector.name, postal_code: @sector.postal_code } }
