...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post cats_url, params: { cat: { last_fed: @cat.last_fed, names: @cat.names, sector_id: @cat.sector_id } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { last_fed: @cat.last_fed, names: @cat.names, sector_id: @cat.sector_id } }
